    ...
    <html lang="pt-BR">
      <body className={`${syne.variable} ${spaceMono.variable} ${dmSans.variable} antialiased`}>
        ...
        <Script id="fb-pixel" strategy="afterInteractive">{`
          ...
          if(!window._fbqInited){window._fbqInited=true;fbq('init','2874835169521602');fbq('track','PageView');}
        `}</Script>
        <noscript>
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img height="1" width="1" style={{ display: 'none' }}
            src="https://www.facebook.com/tr?id=2874835169521602&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
      </body>
